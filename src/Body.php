...
class Body extends Header
{
    ...
    public $parts_class = 'Deltagestor\Peeker\parts';
    ...
    public function get_body()
    {
        ...
        if ($structure === null) {
            $this->log_state('get_body() method $structure is NULL. MsgNo is: ' . (int) $this->MsgNo);
        }
        ...
        if (isset($structure->parts) && count($structure->parts)) {
            ...
            if ($sub_type === 'PLAIN') {
                ...
                if (0) {
                    $this->PLAIN = $this->peek_parent->decode_mime($this->PLAIN);
                }
            }
            ...
            if ($sub_type === 'HTML') {
                ...
                if (0) {
                    $this->HTML = $this->peek_parent->decode_mime($this->HTML);
                }
            }
        }
    ...
    {
        return $this->HTML_rewritten ?? $this->HTML;
    }
     ...
     * to be HTML
     */
    public function put_PLAIN_into_HTML(): void
    {
     ...
     */
    public function wrap_HTML_with_HTML_tags(): void
    {
