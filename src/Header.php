...
class Header extends Layers
{
    ...
    */
    ...
    {
        return $this->_get_address_string('to');
    }

    public function get_from()
    {
        return $this->_get_address_string('from');
    }

    public function get_reply_to()
    {
        return $this->_get_address_string('reply_to');
    }

    public function get_sender()
    {
        return $this->_get_address_string('sender');
    }

    public function get_cc()
    {
        return $this->_get_address_string('cc');
    }

    public function get_bcc()
    {
        return $this->_get_address_string('bcc');
    }

    public function get_return_path()
    {
        return $this->_get_address_string('return_path');
    }
